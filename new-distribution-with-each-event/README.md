...
Static web app, no build step. Serve this directory with any HTTP server. (It cannot be opened directly as a `file://` URL because ES module imports require HTTP.)
